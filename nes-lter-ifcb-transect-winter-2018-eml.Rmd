...
# annotate_eml(annotations = "project_folder/annotations.txt", eml.in = "project_folder/knb-lter-nes.9.1.xml", eml.out = NULL) # this returned Error: Can't subset columns that don't exist. so I contacted developer
