...
# level1b <- read_csv("project_folder/level1b_test.csv")
# level2 <- read_csv("project_folder/level2_test.csv")
...
level2 <- read_csv("https://github.com/klqi/EDI-NES-LTER-2019/raw/f040f31c290ff40baf9a48c9ce2dd57b46336900/plot1/level_2_manual.csv")
...
# add column concentrationFlag to level2 since IFCB triggered only on fluorescence
...
# 20200414_classify_classlabel_matched_sorted.xls
# "amoeba", "ciliate", "detritus", "detritus clear", "Dinophyceae", "Eutintinnus", "Favella", "fecal pellet", "flagellate", "foraminifera", "Gyrodinium", "Helicostomella subulata", "Nauplii", "Polykrikos", "Radiozoa", "Tintinnida", "Tintinnidium mucicola", "Tintinnopsis", "zooplankton", "mix", "Parvicorbicula socialis", "cryptophyta", "Leptocylindrus mediterraneus"
# the following as reported by Brownlee et al. (2016) https://doi.org/10.3354/meps11687
# "ciliate", "Eutintinnus", "Gyrodinium", "Tintinnida", "Tintinnidium mucicola", "Tintinnopsis"
...
# the following empirical Emily Peacock pers. comm.
# "cryptophyta" EN608, "Favella", "Leptocylindrus mediterraneus", "Helicostomella subulata", "mix", "Polykrikos"

undersampledTriggerFluor <- list("amoeba", "bead", "ciliate", "cryptophyta", "detritus", "detritus clear", "Dinophyceae", "Eutintinnus", "Favella", "fecal pellet", "flagellate", "foraminifera", "Gyrodinium", "Helicostomella subulata", "Leptocylindrus mediterraneus", "mix","Nauplii", "other", "Parvicorbicula socialis", "Polykrikos", "Radiozoa", "Tintinnida", "Tintinnidium mucicola", "Tintinnopsis", "zooplankton")

for (i in undersampledTriggerFluor) {
...
# ALSO FOR TWO TABLES figure out how to have 2 catvars templates
...
# # figure out how to rename this so not to be confused with data file
