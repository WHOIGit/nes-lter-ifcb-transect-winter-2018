...
level1b <- read_csv("https://raw.githubusercontent.com/klqi/EDI-NES-LTER-2019/master/auto_join/level_1b_manual.csv")
...
level2 <- read_csv("https://raw.githubusercontent.com/klqi/EDI-NES-LTER-2019/master/plot1/level_2_manual.csv")
...
# ultimately need to strip level1b column "X1"
level1bEDI <- select(level1bEDI, -X1)

# ultimately need to add column concentrationFlag to level2
level2$concentrationFlag = 1  # placeholder
